...
export default function Register() {
  ...
  return (
    <div className="auth-shell relative min-h-screen overflow-hidden px-4 pb-16 pt-24 md:px-8 md:pt-28">
      <div className="pointer-events-none absolute -left-24 top-24 h-72 w-72 rounded-full bg-cyan-200/35 blur-3xl" />
      <div className="pointer-events-none absolute -right-16 bottom-20 h-80 w-80 rounded-full bg-sky-300/30 blur-3xl" />
      ...
      >
        ...
        <div className="overflow-hidden rounded-3xl border border-white/80 bg-white/85 shadow-[0_24px_60px_-28px_rgba(14,165,233,0.35)] backdrop-blur-xl">
          <div className="bg-gradient-to-r from-sky-600 via-blue-500 to-indigo-500 px-8 py-6 text-white">
            ...
            <p className="mt-1.5 text-sm text-white/85">
              Register with email and password to track progress and rankings.
            </p>
          </div>
